...
class ProfilePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color.fromARGB(255, 38, 82, 104),
      body: Column(
        children: [
          const CircleAvatar(
            ...
            child: Row(
              children: [
                ...
                Text(
                  "9874568745",
                  style: TextStyle(
                      color: Color.fromARGB(255, 38, 82, 104), fontSize: 20),
                ),
              ],
            ),
          ),
